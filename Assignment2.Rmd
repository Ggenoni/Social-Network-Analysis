...
2.  A dyadic-independent model incorporating gender attributes to assess individual-level effects; and
...
To focus on strong ties, the directed, valued network is dichotomized and transformed into a network: edges with values of 3 (friend) or 4 (close personal friend) are coded as 1, and all others (0, 1, 2) are coded as 0.
